...
# Set images
player = pygame.image.load("assets/dragon_right.png")
...
def handle_coin():
    global coin_velocity, player_lives
...
def handle_collisions():
    global coin_velocity, player_lives, score
...
def game_over_check():
    global player_lives, running, score
    if player_lives == 0:
...
def update_screen():
    ...
    blit(display_surface, player, player_rect)
